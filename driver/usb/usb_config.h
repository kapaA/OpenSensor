...
//#define USB_SPEEDå_OPTION USB_LOW_SPEED //(not valid option for PIC24F devices)
...
#define USB_DISABLE_SOF_HANDLER //NEW!
...
#define CDC_DATA_OUT_EP_SIZE    96                                                   //Tuned for device programming
#define CDC_DATA_IN_EP_SIZE     96                                                   //Tuned for device programming
