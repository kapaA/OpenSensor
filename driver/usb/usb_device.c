...
/** INCLUDES *******************************************************/
#include "../third_party_sw/usb_stack/usb.h"
#include "HardwareProfile.h"

#include "../third_party_sw/usb_stack/usb_device_local.h"
#include "../third_party_sw/usb_stack/usb_function_cdc.h"
#include "../../system/usbCmd.h"

extern char INbuffer[96];//NEW!
//extern int DR_usb;
...
#endif
{
    ...
    if (d == 1000)
    {
        LATAbits.LATA3 = ~LATAbits.LATA3;	//Toggle output to LED CHANGE! NEW!
        d=0;
    }*/
    BYTE i;
    ...
    if (d == 1000)
    {
        ...
        if(getsUSBUSART(INbuffer, 64)) //check if there are received any data
        {
            //DR_usb = 1;
        }
